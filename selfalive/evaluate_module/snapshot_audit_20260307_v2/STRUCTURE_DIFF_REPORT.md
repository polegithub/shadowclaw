# STRUCTURE_DIFF_REPORT (对比视角重制版)

- 生成时间: `2026-03-07T23:25:06`
- 基准目录: `/root/.openclaw`
- 对比目标: "快照目录结构是否与 OpenClaw 原始结构对齐"
- 呈现方式: code-review 风格（红色缺失 / 绿色新增）
- DB 对比: 不做全文 diff，仅比较 `文件大小 + 前16字节头`

## 总览（文件级）

| 方案 | 基准文件数 | 快照文件数 | 匹配文件数 | 缺失 | 额外 | 覆盖率 |
|---|---:|---:|---:|---:|---:|---:|
| catpawclaw | 177 | 94 | 92 | 85 | 2 | 51.98% |
| kimiclaw | 177 | 13 | 12 | 165 | 1 | 6.78% |
| huoshanclaw | 177 | 22 | 10 | 167 | 12 | 5.65% |

## catpawclaw

### 目录层级对齐（Top-level）
```diff
+ manifest.json/   # 快照新增（基准无）
+ secrets-template.json/   # 快照新增（基准无）
```
...
- workspace/shadowclaw/kimiclaw/workspace/AGENTS.md
- workspace/shadowclaw/kimiclaw/workspace/IDENTITY.md
- workspace/shadowclaw/kimiclaw/workspace/SOUL.md
- workspace/shadowclaw/kimiclaw/workspace/TOOLS.md
- workspace/shadowclaw/kimiclaw/workspace/USER.md
- workspace/shadowclaw/selfalive/evaluate_module/analysis_report_20260307.md
- workspace/shadowclaw/selfalive/evaluate_module/benchmark.sh
- workspace/shadowclaw/selfalive/evaluate_module/evaluation_results.md
- workspace/shadowclaw/selfalive/evaluate_module/openclaw_news_20260307.md
- workspace/shadowclaw/selfalive/evaluate_module/snapshot_audit_20260307/STRUCTURE_DIFF_REPORT.html
- workspace/shadowclaw/selfalive/evaluate_module/snapshot_audit_20260307/STRUCTURE_DIFF_REPORT.md
- workspace/shadowclaw/selfalive/evaluate_module/snapshot_audit_20260307/catpaw_filelist.txt
- workspace/shadowclaw/selfalive/evaluate_module/snapshot_audit_20260307/diff_summary.json
- ... (5 more)
```
...
- agents/main/sessions/cccc3bf5-9c12-47d9-b127-9f76c9c48c73.jsonl
- agents/main/sessions/d19c61a4-3402-48dd-876a-00e5d3b1f933.jsonl
- agents/main/sessions/d5040154-0899-432e-b3fe-389de9b22ea2.jsonl
...
- skills/tavily/scripts/extract.mjs
- skills/tavily/scripts/search.mjs
- ... (85 more)
```
...
- feishu/   # 基准有，快照缺失
- skills/   # 基准有，快照缺失
+ catpawclaw_manifest.json/   # 快照新增（基准无）
+ kimiclaw_manifest.json/   # 快照新增（基准无）
+ manifest.json/   # 快照新增（基准无）
```
...
## 一句话解读
- **catpawclaw**: 覆盖率 51.98%，top-level 缺失 0 个，新增 2 个
- **kimiclaw**: 覆盖率 6.78%，top-level 缺失 4 个，新增 1 个
- **huoshanclaw**: 覆盖率 5.65%，top-level 缺失 4 个，新增 3 个