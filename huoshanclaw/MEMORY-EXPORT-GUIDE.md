...
```bash
SNAPSHOT_DIR="huoshanclaw/snapshot-memory"
...
git add huoshanclaw/snapshot-memory/
git commit -m "huoshanclaw: export memory files for catclaw inheritance"
